...
public class NotesController : ControllerBase
{
    ...
    {
        var notes = await _noteService.GetNotesForUserAsync(User.GetUserId(), queryParams);
    ...
    {
        var note = await _noteService.GetNoteByIdForUserAsync(id, User.GetUserId());
        if (note is null)
        {
    ...
    {
        var createdNote = await _noteService.CreateNoteAsync(userDto, User.GetUserId());
